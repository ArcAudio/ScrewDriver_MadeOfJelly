...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = std::sin(fConst1);
		fConst3 = std::cos(fConst1);
		fConst4 = (0.00651088404f * (std::atan((fConst2 / (fConst3 + -0.0395396911f))) - std::atan((fConst2 / (fConst3 + -25.2910423f)))));
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(0.98999999999999999f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->openHorizontalBox("Piano");
		ui_interface->declare(&fHslider1, "0", "");
		ui_interface->addHorizontalSlider("freq", &fHslider1, 440.0f, 50.0f, 5000.0f, 1.0f);
		ui_interface->declare(&fHslider0, "1", "");
		ui_interface->addHorizontalSlider("damping", &fHslider0, 0.99000001f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec19[0] = (fRec0[2] + (0.0395396911f * (fRec19[1] - fRec0[1])));
			fRec18[0] = (fRec19[1] - (0.0395396911f * (fRec19[0] - fRec18[1])));
			fRec17[0] = (fRec18[1] - (0.0395396911f * (fRec18[0] - fRec17[1])));
			fRec16[0] = (fRec17[1] - (0.0395396911f * (fRec17[0] - fRec16[1])));
			fRec15[0] = (fRec16[1] - (0.0395396911f * (fRec16[0] - fRec15[1])));
			fRec14[0] = (fRec15[1] - (0.0395396911f * (fRec15[0] - fRec14[1])));
			fRec13[0] = (fRec14[1] - (0.0395396911f * (fRec14[0] - fRec13[1])));
			fRec12[0] = (fRec13[1] - (0.0395396911f * (fRec13[0] - fRec12[1])));
			fRec11[0] = (fRec12[1] - (0.0395396911f * (fRec12[0] - fRec11[1])));
			fRec10[0] = (fRec11[1] - (0.0395396911f * (fRec11[0] - fRec10[1])));
			fRec9[0] = (fRec10[1] - (0.0395396911f * (fRec10[0] - fRec9[1])));
			fRec8[0] = (fRec9[1] - (0.0395396911f * (fRec9[0] - fRec8[1])));
			fRec7[0] = (fRec8[1] - (0.0395396911f * (fRec8[0] - fRec7[1])));
			fRec6[0] = (fRec7[1] - (0.0395396911f * (fRec7[0] - fRec6[1])));
			fRec5[0] = (fRec6[1] - (0.0395396911f * (fRec6[0] - fRec5[1])));
			fRec4[0] = (fRec5[1] - (0.0395396911f * (fRec5[0] - fRec4[1])));
			fRec3[0] = (fRec4[1] - (0.0395396911f * (fRec4[0] - fRec3[1])));
			fRec2[(IOTA & 1023)] = (fRec3[1] - (0.0395396911f * (fRec3[0] - fRec2[((IOTA - 1) & 1023)])));
			fRec20[0] = (fSlow1 + (0.999000013f * fRec20[1]));
			float fTemp0 = (fConst0 * ((1.0f / fRec20[0]) - fConst4));
			float fTemp1 = (fTemp0 + -1.0f);
			int iTemp2 = int(fTemp1);
			float fTemp3 = std::floor(fTemp1);
			float fTemp4 = ((fRec2[((IOTA - std::min<int>(961, std::max<int>(0, iTemp2))) & 1023)] * (fTemp3 + (2.0f - fTemp0))) + ((fTemp0 + (-1.0f - fTemp3)) * fRec2[((IOTA - std::min<int>(961, std::max<int>(0, (iTemp2 + 1)))) & 1023)]));
			fVec0[0] = fTemp4;
			fRec0[0] = (float(input0[i]) + (0.5f * (fRec1[0] * (fTemp4 + fVec0[1]))));
			fRec21[0] = (fSlow2 + (0.999000013f * fRec21[1]));
			fRec22[0] = (fSlow3 + (0.999000013f * fRec22[1]));
			float fTemp5 = ((fRec0[0] * fRec21[0]) * fRec22[0]);
