...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "Karplunk6.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.3");
		m->declare("name", "Karplunk6");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Karplunk6");
		ui_interface->declare(0, "0", "");
		ui_interface->openHorizontalBox("String");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp4 = (fTemp0 + (-2.0f - fTemp3));
			float fTemp5 = (fTemp0 + (-3.0f - fTemp3));
			float fTemp6 = (fTemp0 + (-4.0f - fTemp3));
			float fTemp7 = (fTemp0 + (-5.0f - fTemp3));
			float fTemp8 = (fTemp4 * fTemp5);
			float fTemp9 = (((((fRec0[((IOTA - (std::min<int>(960, std::max<int>(0, iTemp2)) + 1)) & 1023)] * (0.0f - fTemp4)) * (0.0f - (0.5f * fTemp5))) * (0.0f - (0.333333343f * fTemp6))) * (0.0f - (0.25f * fTemp7))) + ((fTemp0 + (-1.0f - fTemp3)) * ((((((fRec0[((IOTA - (std::min<int>(960, std::max<int>(0, (iTemp2 + 1))) + 1)) & 1023)] * (0.0f - fTemp5)) * (0.0f - (0.5f * fTemp6))) * (0.0f - (0.333333343f * fTemp7))) + (0.5f * (((fTemp4 * fRec0[((IOTA - (std::min<int>(960, std::max<int>(0, (iTemp2 + 2))) + 1)) & 1023)]) * (0.0f - fTemp6)) * (0.0f - (0.5f * fTemp7))))) + (0.166666672f * ((fTemp8 * fRec0[((IOTA - (std::min<int>(960, std::max<int>(0, (iTemp2 + 3))) + 1)) & 1023)]) * (0.0f - fTemp7)))) + (0.0416666679f * ((fTemp8 * fTemp6) * fRec0[((IOTA - (std::min<int>(960, std::max<int>(0, (iTemp2 + 4))) + 1)) & 1023)])))));
			fVec0[0] = fTemp9;
			fRec0[(IOTA & 1023)] = (float(input0[i]) + (0.5f * (fRec1[0] * (fTemp9 + fVec0[1]))));
			fRec3[0] = (fSlow2 + (0.999000013f * fRec3[1]));
			fRec4[0] = (fSlow3 + (0.999000013f * fRec4[1]));
			float fTemp10 = ((fRec0[((IOTA - 0) & 1023)] * fRec3[0]) * fRec4[0]);
